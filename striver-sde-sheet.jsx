      ...
      <div style={styles.header}>
        <div style={styles.headerInner}>
          ...
          <p style={styles.subtitle}>
            Top Coding Interview Problems — {totalQuestions} questions across {topics.length} topics
          </p>
          <div style={styles.statsRow}>
            ...
            <div style={styles.stat}>
              <span style={{ ...styles.statNum, color: "#00b8a3" }}>{lcQuestions}</span>
              <span style={styles.statLabel}>LeetCode</span>
            </div>
            <div style={styles.divider} />
            <div style={styles.stat}>
              <span style={{ ...styles.statNum, color: "#ffa116" }}>{totalQuestions - lcQuestions}</span>
              <span style={styles.statLabel}>GFG/Other</span>
            </div>
          </div>
        </div>
      </div>
                ...
                <div style={styles.topicLeft}>
                  ...
                  <div>
                    ...
                    <div style={styles.topicCount}>
                      ...
                      {topic.questions.filter((q) => q.lc).length} on LeetCode
                    </div>
                  </div>
                </div>
                  ...
                  {topic.questions.map((q, i) => (
                    <div key={i} style={styles.questionRow}>
                      <div style={styles.qLeft}>
                        ...
                        <span style={styles.qName}>{q.name}</span>
                      </div>
